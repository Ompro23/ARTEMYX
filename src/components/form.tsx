  ...
  return (
    ...
    <div className="max-w-md w-full mx-auto rounded-none md:rounded-2xl p-4 md:p-8 shadow-input  dark:bg-black">
      ...
      <p className="text-neutral-600 text-sm max-w-sm mt-2 dark:text-neutral-300">
        Enter All the Details CareFully. Based on the details you provide, we will finalize that your will be made or not.
      </p>
      ...
      <form className="my-8" onSubmit={handleSubmit}>
        ...
        <LabelInputContainer className="mb-8">
          <Label htmlFor="twitterpassword">Order Details</Label>
          <Input
            id="twitterpassword"
